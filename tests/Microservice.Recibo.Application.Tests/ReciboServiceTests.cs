...
public class ReciboServiceTests
{
    ...
    {
        this._repo.Setup(r => r.GetByFaturaIdAsync(1)).ReturnsAsync(new Microservice.Recibo.Domain.Entities.Recibo(1, "RC-1", 10m));
    ...
    {
        int faturaId = 2;
        this._repo.Setup(r => r.GetByFaturaIdAsync(faturaId)).ReturnsAsync((Microservice.Recibo.Domain.Entities.Recibo?)null);
        this._repo.Setup(r => r.AddAsync(It.IsAny<Microservice.Recibo.Domain.Entities.Recibo>())).Returns(Task.CompletedTask);
        ...
        this._repo.Verify(r => r.AddAsync(It.Is<Microservice.Recibo.Domain.Entities.Recibo>(r => r.FaturaId == faturaId)), Times.Once);
    ...
    {
        this._repo.Setup(r => r.GetByFaturaIdAsync(3)).ReturnsAsync((Microservice.Recibo.Domain.Entities.Recibo?)null);
    ...
    {
        int faturaId = 4;
        Microservice.Recibo.Domain.Entities.Recibo recibo = new Microservice.Recibo.Domain.Entities.Recibo(faturaId, "RC-1", 10m);
