...
public class ProdutoServiceTests
{
    ...
    public async Task CriarProdutoAsync_DadosValidos_DeveCriarProduto()
    {
        ...
        this._repo.Setup(r => r.AddAsync(It.IsAny<Microservice.Produto.Domain.Entities.Produto>())).Returns(Task.CompletedTask);
        ...
        this._repo.Verify(r => r.AddAsync(It.IsAny<Microservice.Produto.Domain.Entities.Produto>()), Times.Once);
    ...
    {
        this._repo.Setup(r => r.GetByIdAsync(1)).ReturnsAsync(new Microservice.Produto.Domain.Entities.Produto { Id = 1, Nome = "M", Preco = 10 });
    ...
    {
        this._repo.Setup(r => r.GetByIdAsync(99)).ReturnsAsync((Microservice.Produto.Domain.Entities.Produto?)null);
    ...
    {
        Microservice.Produto.Domain.Entities.Produto produto = new Microservice.Produto.Domain.Entities.Produto { Id = 1, Nome = "A", Preco = 10 };
    ...
    {
        this._repo.Setup(r => r.GetByIdAsync(2)).ReturnsAsync((Microservice.Produto.Domain.Entities.Produto?)null);
    ...
    {
        Microservice.Produto.Domain.Entities.Produto produto = new Microservice.Produto.Domain.Entities.Produto { Id = 10, Nome = "A", Preco = 10 };
    ...
    {
        this._repo.Setup(r => r.GetByIdAsync(999)).ReturnsAsync((Microservice.Produto.Domain.Entities.Produto?)null);
